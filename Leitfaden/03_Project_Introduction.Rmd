...
As a first step, you will get to know the data set. This step means you will describe the data and answer questions. For this purpose, you often use graphical tools like box plots or histograms. You can also use tables to look at your data and show your readers what you have been doing.
...
Once more: If you get stuck, **Google** and [StackOverflow](https://stackoverflow.com/) are amazing problem solver (besides the Mentors of course).


## Seasonality and Geographic Differences -- Application of Statistical Methods
As a second step the more advanced of you will dive into deeper depth. For this purpose you will analyse the given data with several statistical approaches and draw insightful conclusions from them.
